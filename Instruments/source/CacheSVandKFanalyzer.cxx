...
public:
    ...
    CacheSVandKFanalyzer(const Arguments& _args) : args(_args), syncMode(Parse<SyncMode>(args.mode())), run_period(Parse<analysis::Period>(args.period())), eventWeights(Parse<analysis::Period>(args.period()), JetOrdering::DeepCSV, DiscriminatorWP::Medium, true),
...
PROGRAM_MAIN(analysis::CacheSVandKFanalyzer, Arguments)
